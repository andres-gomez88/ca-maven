...
public class PathUtilities {
    ...
    private static String extentRepPathMac = "/usr/local/reports/";
    private static String extentConfPathMac = "/users/qateam/netbeansprojects/ca-maven/src/test/resources/extent-config.xml";
